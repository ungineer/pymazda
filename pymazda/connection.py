...
USER_AGENT_BASE_API = "MyMazda-Android/8.1.1"
USER_AGENT_USHER_API = "MyMazda/8.1.1 (Google Pixel 3a; Android 11)"
APP_OS = "Android"
APP_VERSION = "8.1.1"
USHER_SDK_VERSION = "11.2.0400.001"
...
class Connection:
    ...
    def __init__(self, email, password, region, websession=None, logginglevel='debug', logfilename=None):
        self.email = email
